...
public class LIB_Dashboard extends FunctionBase {
    ...
    public void goToBrowseBooks() {

        dashboardPage.clickBrowseBooks();

        ExtentReportManager.logInfo(
                "Navigated to Browse Books page"
        );
    }
    ...
    public void verifyBooksSection() {
        ...
        try {
            ...
            ExtentReportManager.logFail(
                    "Books section validation failed: "
                            + e.getMessage()
            );
        }
    }
